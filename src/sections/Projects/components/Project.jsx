  ...
  return (
    <div className='bg-white rounded-lg w-2/3 md:w-[31%] dark:bg-zinc-800 flex flex-col justify-between'>
      ...
      <div className='flex flex-col h-full justify-between p-3 md:p-8'>
        <h3 className='text-lg mb-3 mx-6 whitespace-nowrap 2xl:text-2xl md:mb-4 md:mx-0 dark:text-white'>
          {name}
        </h3>
        ...
        <div className='flex items-center justify-between mt-3 2xl:mt-5'>
          <a
            href={githubLink}
            target='_blank'
