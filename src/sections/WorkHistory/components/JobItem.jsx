  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex items-center justify-between flex-wrap gap-x-3 gap-y-1'>
        ...
        <p className='text-xs whitespace-nowrap md:text-base dark:text-white'>
          <FontAwesomeIcon icon={faCalendar} className='text-gray-400 mr-2' />
          {props.period}
        </p>
      </div>

      <ul className='list-disc ml-4 text-slate-600 mt-3 text-sm sm:mt-3 md:mt-4  sm:text-base dark:text-zinc-400'>
